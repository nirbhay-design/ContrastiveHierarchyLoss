from src.losses.LCAWSupCon import LCAConClsLoss, SupConClsLoss
from src.network.Network import Network, MLP
from src.dataset.data import TieredImagenetDataLoader, Cifar100DataLoader
import torch 
...
def load_dataset(dataset_name, **kwargs):
    if dataset_name == 'tieredimagenet':
        return TieredImagenetDataLoader(**kwargs)
